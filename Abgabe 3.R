...
plot <- ggplot(betas_and_returns) +
  geom_point(aes(x = Portfolio, y = Average_Excess_Return, color = "Average Excess Return"), size = 3, shape = 16) +
...
ggsave("average_excess_returns_vs_consumption_growth_beta_plot.png", plot)
